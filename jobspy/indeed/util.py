...
def get_job_type(attributes: list) -> list[JobType]:
    ...
    Args:
        attributes: List of job attribute dictionaries from API
...
def get_compensation(compensation: dict) -> Compensation | None:
    ...
    Args:
        compensation: Compensation dictionary from API
...
def get_compensation_interval(interval: str) -> CompensationInterval:
    """
    Converts API interval string to CompensationInterval enum
    
    Args:
        interval: Interval string from API (e.g., "HOUR", "YEAR")
        
    Returns:
        CompensationInterval enum value
    """
    interval_mapping = {
        "DAY": "DAILY",
        "YEAR": "YEARLY",
